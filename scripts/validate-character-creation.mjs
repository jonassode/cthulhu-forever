...
(function runTests() {
  ...
  // ── Suite 11: Upbringing Effects (Step 4.5) ──────────────────────────────────

  console.log('\\n── Suite 11: Upbringing Effects (Step 4.5) ─────────────────────────────────');

  // 11.1  canProceed(4.5) returns true for Harsh when CHA/POW >= 7 (no effect applies)
  {
  ...
  // 11.2  canProceed(4.5) returns false for Harsh when CHA < 7 and no rolls done
  {
    resetState(); state.age = 'jazz'; state.upbringing = 'harsh';
    state.attrMode = 'points';
  ...
  // 11.3  canProceed(4.5) returns false for Harsh when rolls done but no bond choices
  {
    resetState(); state.age = 'jazz'; state.upbringing = 'harsh';
    state.attrMode = 'points';
    state.pointsAttr = { STR: 12, CON: 12, DEX: 12, INT: 12, POW: 8, CHA: 5 };
  ...
  // 11.4  canProceed(4.5) returns true for Harsh when rolls done and both bond choices made
  {
    resetState(); state.age = 'jazz'; state.upbringing = 'harsh';
    state.attrMode = 'points';
    state.pointsAttr = { STR: 12, CON: 12, DEX: 12, INT: 12, POW: 8, CHA: 5 };
  ...
  // 11.5  Harsh bond deduction applies via getBondEffectiveValue
  {
    resetState(); state.age = 'jazz'; state.upbringing = 'harsh';
    state.attrMode = 'points';
  ...
  // 11.6  upbringingReduction is clamped to 0 (bond can't go below 0)
  {
    resetState(); state.age = 'jazz'; state.upbringing = 'harsh';
    state.attrMode = 'points';
  ...
  // 11.7  Very Harsh: canProceed(4.5) = false before rolling d100
  {
    resetState(); state.age = 'jazz'; state.upbringing = 'very_harsh';
    state.attrMode = 'points';
    state.pointsAttr = { STR: 12, CON: 12, DEX: 12, INT: 12, POW: 12, CHA: 12 };
  ...
  // 11.8  Very Harsh: canProceed(4.5) = true after rolling d100 when CHA/POW >= 10
  {
    resetState(); state.age = 'jazz'; state.upbringing = 'very_harsh';
    state.attrMode = 'points';
  ...
  // 11.9  Very Harsh: canProceed(4.5) = false when CHA < 10 and no adaptation chosen
  {
    resetState(); state.age = 'jazz'; state.upbringing = 'very_harsh';
    state.attrMode = 'points';
  ...
  // 11.10  Very Harsh: canProceed(4.5) = true after full adaptation for CHA < 10
  {
    resetState(); state.age = 'jazz'; state.upbringing = 'very_harsh';
    state.attrMode = 'points';
    state.pointsAttr = { STR: 12, CON: 12, DEX: 12, INT: 12, POW: 10, CHA: 8 };
  ...
  // 11.11  upbringingChaReduction reduces CHA in getAttrValue
  {
    resetState(); state.age = 'jazz'; state.upbringing = 'very_harsh';
    state.attrMode = 'points';
    state.pointsAttr = { STR: 12, CON: 12, DEX: 12, INT: 12, POW: 10, CHA: 12 };
  ...
  // 11.12  upbringingPowReduction reduces POW in getAttrValue and affects derived stats
  {
    resetState(); state.age = 'jazz'; state.upbringing = 'very_harsh';
    state.attrMode = 'points';
    state.pointsAttr = { STR: 12, CON: 12, DEX: 12, INT: 12, POW: 12, CHA: 12 };
  ...
  // 11.13  resetUpbringingEffectsState clears all upbringing effects state
  {
    resetState(); state.age = 'jazz'; state.upbringing = 'very_harsh';
    state.attrMode = 'points';
    state.pointsAttr = { STR: 12, CON: 12, DEX: 12, INT: 12, POW: 10, CHA: 8 };
