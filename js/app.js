...
.cb-checked { }
.inc-adapted { background: #fff; color: #000; border: 1px solid #555; border-radius: 3px; font-family: Arial, Helvetica, sans-serif; font-size: 6.5pt; text-transform: uppercase; letter-spacing: .15em; padding: 1px 5px; margin-left: 4px; }
