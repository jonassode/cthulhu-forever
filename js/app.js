...
function exportToOriginalSheet() {
  ...
  // Era-specific heading font: Age of Sails uses 'Sail', all other eras use 'Cinzel'
  const eraHeadFont = state.age === 'sails' ? 'Sail' : 'Cinzel';
  const eraExtraFonts = state.age === 'sails' ? '&family=Sail' : '';
...
<link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@400;600;700;900&family=Caveat:wght@400;600${eraExtraFonts}&display=swap" rel="stylesheet"/>
<style>
...
.era-banner-title { font-family: '${eraHeadFont}', serif; font-size: 14pt; font-weight: 900; letter-spacing: .08em; text-transform: uppercase; line-height: 1; }
