...
function _eraAccordionItem(id, icon, title, dates, desc, details) {
...
function renderStep1() {
  ...
  <div class="step-content">
    ...
    <div class="era-timeline">
      ${_eraAccordionItem('victorian', '🕯️', 'The Victorian Era', '1837–1901',
      ...
      ${_eraAccordionItem('ww1', '✈️', 'World War I', '1914–1918',
      ...
      ${_eraAccordionItem('ww2', '⚔️', 'World War II', '1939–1945',
      ...
      ${_eraAccordionItem('coldwar', '🛰️', 'The Cold War Era', '1950s–1980s',
